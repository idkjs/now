...
# -*- coding: utf-8 -*-
#
# now documentation build configuration file, created by
# sphinx-quickstart.
#
...
latex_documents = [
    (master_doc, 'now.tex', 'now Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'now', 'now Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'now', 'now Documentation',
     author, 'now', 'One line description of project.',
     'Miscellaneous'),
]
